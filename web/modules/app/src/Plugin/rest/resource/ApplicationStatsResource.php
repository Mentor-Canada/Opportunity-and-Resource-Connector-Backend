...
/**
 * @RestResource(
 *   id = "application_stats_resource",
 *   label = @Translation("Application Stats Resource"),
 *   uri_paths = {
 *     "canonical" = "/a/utils/stats/application"
 *   }
 * )
 */
class ApplicationStatsResource extends ResourceBase
{
    public function get()
    {
